function [Psb_m, R_output1, T_output1] = self_calib_1(Psb, normalization, centers)
...
[metric_cameras, ~] = metr(Ps, normmMat, centers', options);
...
function [metric_cameras, metric_upgrade] = metr(cameras, normalisations, centers, options)
