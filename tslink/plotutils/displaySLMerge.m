...
% plot closest pairs
%scatter(X(1,i),X(2,i),250,'s','filled','MarkerEdgeColor',c1,'MarkerFaceColor','w','MarkerFaceAlpha',1,'LineWidth',1.8);
%scatter(X(1,j),X(2,j),250,'s','filled','MarkerEdgeColor',c2,'MarkerFaceColor','w','MarkerFaceAlpha',1,'LineWidth',1.8);
