function [ok, msScore, msOutput] = isMergeableGricSubspace4(X, L, i, j, lambda1 , lambda2,sigma)
...
d = 4; % dimension of the manifold
r = 5; % dimenson of the ambient space
%%------------------------------------------------------------
...
mi = fit_subspace(Xi,4);
mj = fit_subspace(Xj,4);
mij = fit_subspace(Xij,4);
% compute the residuals
ri = res_subspace(Xi, mi);
rj = res_subspace(Xj, mj);
rij = res_subspace(Xij, mij);
