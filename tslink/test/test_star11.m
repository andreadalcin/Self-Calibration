...
cd(fileparts(which('test_star11.m')));
addpath(genpath('../'))
...
saveDir = ['../../../Results/tslink_test/jdata/star11/',dt,'/'];
...
for iter = 1:maxIter
    ...
    for e = 1:nEpsis
        ...
        %%
        me1(s,e,iter) = approxMissErrorFast(C1{s,e,iter},G);
        me2(s,e,iter) = approxMissErrorFast(C2{s,e,iter},G);
        me3(s,e,iter) = approxMissErrorFast(C3{s,e,iter},G);
        me4(s,e,iter) = approxMissErrorFast(C4{s,e,iter},G);
    end
end
