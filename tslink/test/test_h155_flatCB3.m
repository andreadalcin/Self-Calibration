...
for modelType = {'flat2'}%{'flat2','flat3','mixedFlats'}
    ...
    saveDir = ['../../../Results/h155/CB3/',dt,'/',modelType,'/trial',id,'/'];
    ...
    nEpsis = 4;
    kappaSigma = linspace(5,9,nEpsis);
    maxIter = 2;
    kappa = 10;
    epsiNfa = 1;
    ...
    if(o_dumpTestResults)
        ...
        writecell([nameDataset;{'mean'};{'median'}], filename,'Sheet','Silhouette','Range','A2');
        writematrix(meanSil,filename,'Sheet','Silhouette','Range','B2');
      
        writematrix(silhouette,filename,'Sheet',nameSheet,'Range','B3');
